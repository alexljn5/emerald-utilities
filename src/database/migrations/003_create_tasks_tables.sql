-- ============================================================
-- Migration 003: Create tasks tables (notes, tasks, task_tags)
-- ============================================================
-- This migration creates the tasks schema for databases that
-- were initialized before pride.sql was added to the fresh
-- initialization path. Safe to run on any database state.
-- ============================================================
