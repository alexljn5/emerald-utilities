...
```
postgres://alexljn5:[REDACTED]@192.168.1.50:5432/emerald_utilities
```
...
```bash
@reboot sleep 17 && su - alexljn5 -c "/home/alexljn5/INFHUB/infhub_scripts/start_emerald_database.sh >> /home/alexljn5/emerald-db-start.log 2>&1"
```
...
Type=oneshot
RemainAfterExit=yes
WorkingDirectory=/home/alexljn5/emerald-utilities/src/database
