        ...
        <PageShell title="Emerald Utilities" route={route} setRoute={setRoute} showBack={false} leftChildren={
            <div className="navBox">
                ...
                <div className="navButtons">
                    ...
                    <button className="nav-btn full" type="button" onClick={() => setRoute('tasks')}>Tasks</button>
                    <button className="nav-btn full" type="button" onClick={() => setRoute('networkMonitoring')}>Network Monitor</button>
                    <button className="nav-btn full" type="button" onClick={() => setRoute('database')}>Database</button>
                    <button className="nav-btn full" type="button" onClick={() => setRoute('internet')}>Internet / Browser</button>
                    <button className="nav-btn full" type="button" onClick={() => setRoute('portfolio')}>Portfolio Monitor</button>
