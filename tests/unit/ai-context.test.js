...
test('roleOf maps alexljn5 to user', () => {
    assert.equal(roleOf('alexljn5'), 'user');
});
...
test('buildContext prepends system prompt when provided', () => {
    const messages = [{ author: 'alexljn5', content: 'hello' }];
...
test('buildConversationContext orders messages for correct truncation priority', () => {
    const recent = [
        { id: 'r1', author: 'alexljn5', content: 'old user message', timestamp: '2024-01-01T00:00:00Z' },
...
test('buildConversationContext deduplicates messages across recent and retrieved', () => {
    const recent = [
        { id: 'm1', author: 'alexljn5', content: 'same message', timestamp: '2024-01-01T00:00:00Z' },
    ];
    const retrieved = [
        {
            id: 'm1',
            ...
            window: [{ id: 'm1', author: 'alexljn5', content: 'same message', timestamp: '2024-01-01T00:00:00Z' }],
        },
    ];
...
test('buildConversationContext current message is not duplicated in recent', () => {
    const recent = [
        { id: 'r1', author: 'alexljn5', content: 'previous message', timestamp: '2024-01-01T00:00:00Z' },
    ];
...
test('context for "What are we doing?" includes preceding "hug" turn', () => {
    ...
    const recent = [
        { id: 'm1', author: 'alexljn5', content: 'I just hugged you.', timestamp: '2024-01-01T00:00:00Z' },
...
test('context for "What did I just do?" includes preceding action', () => {
    const recent = [
        { id: 'm1', author: 'alexljn5', content: 'I put a blanket around you.', timestamp: '2024-01-01T00:00:00Z' },
...
test('context for "What did I just do?" with eggs and bacon', () => {
    const recent = [
        { id: 'm1', author: 'alexljn5', content: 'I just gave you eggs and bacon.', timestamp: '2024-01-01T00:00:00Z' },
...
test('separate conversation cannot see messages from another conversation', () => {
    const recentA = [
        { id: 'a1', author: 'alexljn5', content: 'Secret from conversation A', timestamp: '2024-01-01T00:00:00Z' },
    ];
    const recentB = [
        { id: 'b1', author: 'alexljn5', content: 'Public from conversation B', timestamp: '2024-01-01T00:00:00Z' },
    ];
...
test('multi-turn conversation preserves all turns in order', () => {
    const recent = [
        { id: 'm1', author: 'alexljn5', content: 'Turn 1: Hello', timestamp: '2024-01-01T00:00:00Z' },
        { id: 'm2', author: 'Cream', content: 'Turn 1: Hi!', timestamp: '2024-01-01T00:00:01Z' },
        { id: 'm3', author: 'alexljn5', content: 'Turn 2: How are you?', timestamp: '2024-01-01T00:00:02Z' },
        { id: 'm4', author: 'Cream', content: 'Turn 2: I am well!', timestamp: '2024-01-01T00:00:03Z' },
        { id: 'm5', author: 'alexljn5', content: 'Turn 3: What is 2+2?', timestamp: '2024-01-01T00:00:04Z' },
    ];
...
test('buildConversationContext logs debug info', () => {
    ...
    const bundle = buildConversationContext({
        ...
        userMessage: 'test',
        recent: [{ id: 'r1', author: 'alexljn5', content: 'recent', timestamp: '2024-01-01T00:00:00Z' }],
        retrieved: [],
