                ...
                {showInfo && (
                    <div className="infoModal" onClick={() => setShowInfo(false)}>
                        <div className="infoModalContent" onClick={(e) => e.stopPropagation()}>
                            ...
                            <p>The Containers page needs SSH access to <code>{'<server-hostname>'}</code> (Tailscale MagicDNS) to list Docker containers. Follow these steps once per machine.</p>
