...
export function getSshConfig() {
    ...
    return {
        ...
        user: config.sshUser || process.env.BOT_SSH_USER || 'emerald-user',
...
const SCREEN_BOT_DIR = process.env.BOT_SCREEN_DIR || '/home/emerald-user/INFHUB/infbot';
...
// Tailscale MagicDNS hostnames (e.g. '<server-hostname>') are resolved by the
